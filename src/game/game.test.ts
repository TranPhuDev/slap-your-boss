...
describe('game formulas', () => {
  ...
  it('computes combo and scoring boundaries', () => {
    ...
    expect(faceDamageFromRaw(1200)).toBe(44)
    expect(faceDamageFromRaw(2100)).toBe(63)
    expect(faceDamageFromRaw(5000)).toBeLessThanOrEqual(100)
    expect(stressReleasedFromSlaps(20, 100)).toBe(44)
    expect(stressReleasedFromSlaps(72, 100)).toBe(100)
    expect(finalScore(63, 44, 100)).toBe(64)
    expect(finalScore(100, 100, 100)).toBe(100)
    expect(rankForScore(29)).toBe('Calm Employee')
    expect(rankForScore(50)).toBe('Deadline Fighter')
    expect(rankForScore(60)).toBe('Meeting Breaker')
    expect(rankForScore(70)).toBe('Corporate Survivor')
    expect(rankForScore(85)).toBe('Executive Menace')
    expect(rankForScore(95)).toBe('Boss Battle Legend')
  })
